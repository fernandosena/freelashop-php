...
class Dash extends Admin
{
    ...
    public function home(?array $data): void
    {
        ...
        echo $this->view->render("widgets/dash/home", [
            ...
            "head" => $head,
            "control" => (object)[
                "subscribers" => (new AppSubscription())->find("status = :s", "s=paid")->count(),
            ...
            "users" => (object)[
                "contratantes" => (new User())->find("type = 'contractor'")->count(),
                "freelancers" => (new User())->find("type = 'freelancer'")->count(),
