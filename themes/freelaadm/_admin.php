...
<head>
    ...
    <link rel="stylesheet" href="<?= theme("/assets/css/codemirror.css", CONF_VIEW_ADMIN); ?>"/>
    <link rel="stylesheet" href="<?= theme("/assets/css/monokai.css", CONF_VIEW_ADMIN); ?>"/>
        ...
        <ul class="dash_sidebar_nav">
            ...
            if(user()->level >= 2){
                ...
                if(user()->level >= 4){
                    ...
                    echo $nav("pencil-square-o", "project/pending", "Projetos");
                    if(user()->level >= 5){
                        echo $nav("pencil-square-o", "contract/home", "Contratos");
        ...
        <div class="dash_userbar">
            <div class="dash_userbar_box">
                <div class="dash_content_box">
                    <h1 class="icon-cog transition"><a href="<?= url("/admin/dash"); ?>"><?= CONF_SITE_NAME ?></a></h1>
...
<script src="<?= theme("/assets/js/codemirror.js", CONF_VIEW_ADMIN); ?>"></script>
<script src="<?= theme("/assets/js/css.js", CONF_VIEW_ADMIN); ?>"></script>
<script src="<?= theme("/assets/js/xml.js", CONF_VIEW_ADMIN); ?>"></script>
<script src="<?= theme("/assets/js/htmlmixed.js", CONF_VIEW_ADMIN); ?>"></script>
