        ...
        <div class="dash_content_app_box">
            <form class="app_form" action="<?= url("/admin/faq/question/{$channel->id}"); ?>" method="post">
                ...
                <label class="label">
                    ...
                    <textarea name="response" class="mce" rows="3" placeholder="Resolver a pergunta"></textarea>
                </label>
    ...
    <?php else: ?>
        ...
        <div class="dash_content_app_box">
            <form class="app_form" action="<?= url("/admin/faq/question/{$channel->id}/{$question->id}"); ?>"
                ...
                <label class="label">
                    <span class="legend">*Resposta:</span>
                    <textarea class="mce" name="response" rows="3" placeholder="Resolver a pergunta"
