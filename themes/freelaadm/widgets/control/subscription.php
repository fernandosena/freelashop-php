                    ...
                    <select name="plan_id" required>
                        <?php foreach ($plans as $plan):
                            ...
                            <option <?= $selected($plan->id); ?> value="<?= $plan->id; ?>"><?= $plan->name; ?> -
                                R$ <?= str_price($plan->minimum_price); ?>/<?= ucfirst(translate($plan->interval)); ?></option>
                        <?php endforeach; ?>
                    </select>
                </label>
            ...
            <div class="label_g2">
                <label class="label">
                    ...
                    <select name="status" required>
                        ...
                        ?>
                        <option <?= $selected("paid"); ?> value="active">Pago</option>
            ...
            <div class="label_g2">
                <label class="label">
                    ...
                    <input class="mask-date" type="text" name="next_due"
                           value="<?= date("d/m/Y", strtotime($subscription->next_billing_at)); ?>" required/>
                </label>
